...
public:
	...
	const CameraState &				GetCameraState() const				{ ACPH_ASSERT(mInFrame); return mCameraState; }
	const Frustum &					GetCameraFrustum() const			{ ACPH_ASSERT(mInFrame); return mCameraFrustum; }
	...
	const Frustum &					GetLightFrustum() const				{ ACPH_ASSERT(mInFrame); return mLightFrustum; }
	...
	uint							GetCurrentFrameIndex() const		{ ACPH_ASSERT(mInFrame); return mFrameIndex; }
