...
public:
	...
	VkCommandBuffer					GetCommandBuffer()												{ ACPH_ASSERT(mInFrame); return mCommandBuffers[mFrameIndex]; }
...
private:
	...
	ACPH_MAKE_HASH_STRUCT(Key, KeyHasher, t.mSize, t.mUsage, t.mProperties)
	...
	ACPH_MAKE_HASH_STRUCT(Key, MemKeyHasher, t.mUsage, t.mProperties, t.mSize)
