...
if (NOT CROSS_COMPILE_ARM AND (Vulkan_FOUND OR WIN32 OR ("${CMAKE_SYSTEM_NAME}" MATCHES "Darwin")))
	...
	if (Vulkan_FOUND)
		...
		target_link_libraries(TestFramework LINK_PUBLIC AsterCore ${Vulkan_LIBRARIES})
		if (ACPH_ENABLE_VULKAN)
			target_compile_definitions(TestFramework PRIVATE ACPH_ENABLE_VULKAN)
		endif()
	endif()
	if (WIN32)
		# Windows configuration
		target_link_libraries(TestFramework LINK_PUBLIC AsterCore dxguid.lib dinput8.lib dxgi.lib d3d12.lib d3dcompiler.lib shcore.lib)
	endif()
	if (LINUX)
		# Linux configuration
		target_link_libraries(TestFramework LINK_PUBLIC AsterCore X11)
	endif()
	if ("${CMAKE_SYSTEM_NAME}" MATCHES "Darwin")
		# macOS configuration
		target_link_libraries(TestFramework LINK_PUBLIC AsterCore "-framework Cocoa -framework Metal -framework MetalKit -framework GameController")
