...
{
public:
	ACPH_DECLARE_RTTI_VIRTUAL(ACPH_NO_EXPORT, DeformedHeightFieldShapeTest)
...
private:
	// Get the center of the path at time inTime, this follows a path that resembles the AsterCore logo
