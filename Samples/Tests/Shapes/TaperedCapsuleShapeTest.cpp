...
ACPH_IMPLEMENT_RTTI_VIRTUAL(TaperedCapsuleShapeTest)
{
	ACPH_ADD_BASE_CLASS(TaperedCapsuleShapeTest, Test)
}
...
void TaperedCapsuleShapeTest::Initialize()
{
	...
	mBodyInterface->CreateAndAddBody(BodyCreationSettings(big_taperedcapsule, RVec3(20, 10, 0), Quat::sRotation(Vec3::sAxisX(), 0.5f * ACPH_PI), EMotionType::Dynamic, Layers::MOVING), EActivation::Activate);
