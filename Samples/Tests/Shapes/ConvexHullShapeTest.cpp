...
ACPH_IMPLEMENT_RTTI_VIRTUAL(ConvexHullShapeTest)
{
	ACPH_ADD_BASE_CLASS(ConvexHullShapeTest, Test)
}
...
void ConvexHullShapeTest::Initialize()
{
	...
	for (float theta = 0.0f; theta <= 2.0f * ACPH_PI; theta += ACPH_PI / 128.0f)
	{
