...
ACPH_IMPLEMENT_RTTI_VIRTUAL(RotatedTranslatedShapeTest)
{
	ACPH_ADD_BASE_CLASS(RotatedTranslatedShapeTest, Test)
}
...
void RotatedTranslatedShapeTest::Initialize()
{
	...
	Ref<RotatedTranslatedShapeSettings> rot_trans = new RotatedTranslatedShapeSettings(Vec3(0, 2.5f, 0), Quat::sRotation(Vec3::sAxisX(), ACPH_PI), convex_hull);
