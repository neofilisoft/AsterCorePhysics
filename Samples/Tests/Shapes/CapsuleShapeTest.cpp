...
ACPH_IMPLEMENT_RTTI_VIRTUAL(CapsuleShapeTest)
{
	ACPH_ADD_BASE_CLASS(CapsuleShapeTest, Test)
}
...
void CapsuleShapeTest::Initialize()
{
	...
	// Capsule on cylinder
	mBodyInterface->CreateAndAddBody(BodyCreationSettings(big_capsule, RVec3(10, 10, 0), Quat::sRotation(Vec3::sAxisX(), 0.5f * ACPH_PI), EMotionType::Dynamic, Layers::MOVING), EActivation::Activate);
