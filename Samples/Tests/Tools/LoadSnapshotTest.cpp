...
ACPH_IMPLEMENT_RTTI_VIRTUAL(LoadSnapshotTest)
{
	ACPH_ADD_BASE_CLASS(LoadSnapshotTest, Test)
}
...
void LoadSnapshotTest::Initialize()
{
	...
	ofn.lpstrTitle = "Select a AsterCore Binary Snapshot";
	...
	switch (sUpAxis)
	{
	case 0:		up_rotation = Quat::sRotation(Vec3::sAxisZ(), 0.5f * ACPH_PI);	break;
	case 2:		up_rotation = Quat::sRotation(Vec3::sAxisX(), -0.5f * ACPH_PI);	break;
