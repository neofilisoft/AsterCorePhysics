...
ACPH_IMPLEMENT_RTTI_VIRTUAL(CharacterPlanetTest)
{
	ACPH_ADD_BASE_CLASS(CharacterPlanetTest, Test)
}
...
void CharacterPlanetTest::Initialize()
{
	...
	for (int i = 0; i < 200; ++i)
	{
		uniform_real_distribution<float> theta(0, ACPH_PI);
		uniform_real_distribution<float> phi(0, 2 * ACPH_PI);
