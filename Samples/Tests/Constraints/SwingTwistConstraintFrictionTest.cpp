...
ACPH_IMPLEMENT_RTTI_VIRTUAL(SwingTwistConstraintFrictionTest)
{
	ACPH_ADD_BASE_CLASS(SwingTwistConstraintFrictionTest, Test)
}
...
void SwingTwistConstraintFrictionTest::Initialize()
{
	...
	settings.mTwistMinAngle = -ACPH_PI;
	settings.mTwistMaxAngle = ACPH_PI;
