...
ACPH_IMPLEMENT_RTTI_VIRTUAL(LoadRigTest)
{
	ACPH_ADD_BASE_CLASS(LoadRigTest, Test)
}
...
void LoadRigTest::Initialize()
{
	...
	// Load ragdoll
	mRagdollSettings = RagdollLoader::sLoad("Entity.tof", EMotionType::Dynamic, sConstraintType);
