...
ACPH_IMPLEMENT_RTTI_VIRTUAL(KinematicRigTest)
{
	ACPH_ADD_BASE_CLASS(KinematicRigTest, Test)
}
...
void KinematicRigTest::Initialize()
{
	...
	// Load ragdoll
	mRagdollSettings = RagdollLoader::sLoad("Entity.tof", EMotionType::Kinematic);
