...
{
public:
	ACPH_DECLARE_RTTI_VIRTUAL(ACPH_NO_EXPORT, BigWorldTest)
	...
	virtual String			GetStatusString() const override							{ return "Define ACPH_DOUBLE_PRECISION for an accurate simulation!"; }
