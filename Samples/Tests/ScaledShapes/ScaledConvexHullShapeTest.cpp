...
ACPH_IMPLEMENT_RTTI_VIRTUAL(ScaledConvexHullShapeTest)
{
	ACPH_ADD_BASE_CLASS(ScaledConvexHullShapeTest, Test)
}
...
void ScaledConvexHullShapeTest::Initialize()
{
	...
	Mat44 m = Mat44::sTranslation(Vec3(3.0f, -2.0f, 1.0f)) * Mat44::sRotationY(0.2f * ACPH_PI) * Mat44::sRotationZ(0.1f * ACPH_PI);
	for (Vec3 &v : box)
		v = m * v;
