...
ACPH_IMPLEMENT_RTTI_VIRTUAL(ScaledMutableCompoundShapeTest)
{
	ACPH_ADD_BASE_CLASS(ScaledMutableCompoundShapeTest, Test)
}
...
void ScaledMutableCompoundShapeTest::Initialize()
{
	...
	compound_shape->AddShape(Vec3(-5, -1.5f, -0.5f), Quat::sRotation(Vec3::sAxisZ(), 0.5f * ACPH_PI), end1_shape);
