...
#include <AsterCore/Physics/Collision/BroadPhase/BroadPhaseBruteForce.h>
#include <AsterCore/Physics/Collision/BroadPhase/BroadPhaseQuadTree.h>
#include <random>

ACPH_IMPLEMENT_RTTI_ABSTRACT(BroadPhaseTest)
{
	ACPH_ADD_BASE_CLASS(BroadPhaseTest, Test)
}
