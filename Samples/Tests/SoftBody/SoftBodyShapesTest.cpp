...
ACPH_IMPLEMENT_RTTI_VIRTUAL(SoftBodyShapesTest)
{
	ACPH_ADD_BASE_CLASS(SoftBodyShapesTest, Test)
}
...
void SoftBodyShapesTest::Initialize()
{
	...
	SoftBodyCreationSettings cloth(SoftBodyCreator::CreateClothWithFixatedCorners(), RVec3(0, 10.0f, 0), Quat::sRotation(Vec3::sAxisY(), 0.25f * ACPH_PI), Layers::MOVING);
	...
	Quat rotate_x = Quat::sRotation(Vec3::sAxisX(), 0.5f * ACPH_PI);
