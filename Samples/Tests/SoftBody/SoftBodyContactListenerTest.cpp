...
ACPH_IMPLEMENT_RTTI_VIRTUAL(SoftBodyContactListenerTest)
{
	ACPH_ADD_BASE_CLASS(SoftBodyContactListenerTest, Test)
}
...
void SoftBodyContactListenerTest::StartCycle()
{
	...
	SoftBodyCreationSettings cloth(cloth_settings, RVec3(0, 5, 0), Quat::sRotation(Vec3::sAxisY(), 0.25f * ACPH_PI), Layers::MOVING);
