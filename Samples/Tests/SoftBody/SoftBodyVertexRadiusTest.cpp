...
ACPH_IMPLEMENT_RTTI_VIRTUAL(SoftBodyVertexRadiusTest)
{
	ACPH_ADD_BASE_CLASS(SoftBodyVertexRadiusTest, Test)
}
...
void SoftBodyVertexRadiusTest::Initialize()
{
	...
	SoftBodyCreationSettings cloth(mSharedSettings, RVec3(0, 5, 0), Quat::sRotation(Vec3::sAxisY(), 0.25f * ACPH_PI), Layers::MOVING);
