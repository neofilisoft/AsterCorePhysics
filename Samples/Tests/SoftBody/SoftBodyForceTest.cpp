...
ACPH_IMPLEMENT_RTTI_VIRTUAL(SoftBodyForceTest)
{
	ACPH_ADD_BASE_CLASS(SoftBodyForceTest, Test)
}
...
void SoftBodyForceTest::Initialize()
{
	...
	SoftBodyCreationSettings cloth(SoftBodyCreator::CreateCloth(cGridSize, cGridSize, 0.75f, inv_mass), RVec3(0, 15.0f, 0), Quat::sRotation(Vec3::sAxisX(), 0.5f * ACPH_PI), Layers::MOVING);
