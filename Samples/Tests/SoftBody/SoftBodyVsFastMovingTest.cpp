...
ACPH_IMPLEMENT_RTTI_VIRTUAL(SoftBodyVsFastMovingTest)
{
	ACPH_ADD_BASE_CLASS(SoftBodyVsFastMovingTest, Test)
}
...
void SoftBodyVsFastMovingTest::Initialize()
{
	...
	SoftBodyCreationSettings cloth(SoftBodyCreator::CreateClothWithFixatedCorners(), RVec3(0, 15, 0), Quat::sRotation(Vec3::sAxisX(), 0.1f * ACPH_PI) * Quat::sRotation(Vec3::sAxisY(), 0.25f * ACPH_PI), Layers::MOVING);
