...
ACPH_IMPLEMENT_RTTI_VIRTUAL(SoftBodyUpdatePositionTest)
{
	ACPH_ADD_BASE_CLASS(SoftBodyUpdatePositionTest, Test)
}
...
void SoftBodyUpdatePositionTest::Initialize()
{
	...
	SoftBodyCreationSettings sphere(SoftBodySharedSettings::sCreateCube(5, 0.5f), RVec3::sZero(), Quat::sRotation(Vec3::sReplicate(1.0f / sqrt(3.0f)), 0.25f * ACPH_PI), Layers::MOVING);
