...
ACPH_IMPLEMENT_RTTI_VIRTUAL(EnhancedInternalEdgeRemovalTest)
{
	ACPH_ADD_BASE_CLASS(EnhancedInternalEdgeRemovalTest, Test)
}
...
void EnhancedInternalEdgeRemovalTest::PrePhysicsUpdate(const PreUpdateParams &inParams)
{
	...
	mBodyInterface->AddTorque(mLevelBall, Vec3(ACPH_PI * 4, 0, 0));
}
