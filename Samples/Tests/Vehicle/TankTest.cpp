...
ACPH_IMPLEMENT_RTTI_VIRTUAL(TankTest)
{
	ACPH_ADD_BASE_CLASS(TankTest, VehicleTest)
}
...
void TankTest::Initialize()
{
	...
	BodyCreationSettings barrel_body_setings(new CylinderShape(half_barrel_length, barrel_radius), barrel_position, Quat::sRotation(Vec3::sAxisX(), 0.5f * ACPH_PI), EMotionType::Dynamic, Layers::MOVING);
