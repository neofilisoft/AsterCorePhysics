...
#include <AsterCore/Physics/Constraints/PointConstraint.h>
...
#include <AsterCore/Physics/Constraints/ConeConstraint.h>
...
RagdollSettings *RagdollLoader::sCreate()
{
	...
	Quat rotations[] = {
		Quat::sRotation(Vec3::sAxisZ(), 0.5f * ACPH_PI),		 // Lower Body
		Quat::sRotation(Vec3::sAxisZ(), 0.5f * ACPH_PI),		 // Mid Body
		Quat::sRotation(Vec3::sAxisZ(), 0.5f * ACPH_PI),		 // Upper Body
		Quat::sIdentity(),									 // Head
		Quat::sRotation(Vec3::sAxisZ(), 0.5f * ACPH_PI),		 // Upper Arm L
		Quat::sRotation(Vec3::sAxisZ(), 0.5f * ACPH_PI),		 // Upper Arm R
		Quat::sRotation(Vec3::sAxisZ(), 0.5f * ACPH_PI),		 // Lower Arm L
		Quat::sRotation(Vec3::sAxisZ(), 0.5f * ACPH_PI),		 // Lower Arm R
