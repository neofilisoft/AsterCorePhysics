...
#include <AsterCore/ObjectStream/ObjectStreamTextIn.h>
...
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL_BASE(ACPH_NO_EXPORT, TestSerializableBase)
...
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL_BASE(ACPH_NO_EXPORT, TestSerializableBase2)
...
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_NO_EXPORT, TestSerializable)
...
ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(TestSerializableBase)
{
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mUInt8)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mUInt16)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mInt)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mUInt32)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mUInt64)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mFloat)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mDouble)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mBool)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mFloat3)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mFloat4)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mDouble3)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mQuat)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mVec3)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mDVec3)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mVec4)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mUVec4)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mMat44)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mDMat44)
	ACPH_ADD_ATTRIBUTE(TestSerializableBase, mString)
}

ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(TestSerializableBase2)
{
	ACPH_ADD_ATTRIBUTE(TestSerializableBase2, mBase2)
}

ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(TestSerializable)
{
	ACPH_ADD_BASE_CLASS(TestSerializable, TestSerializableBase)
	ACPH_ADD_BASE_CLASS(TestSerializable, TestSerializableBase2)

	ACPH_ADD_ENUM_ATTRIBUTE(TestSerializable, mEnum)
	ACPH_ADD_ATTRIBUTE(TestSerializable, mIntVector)
	ACPH_ADD_ATTRIBUTE(TestSerializable, mBoolVector)
	ACPH_ADD_ATTRIBUTE(TestSerializable, mFloatVector)
	ACPH_ADD_ATTRIBUTE(TestSerializable, mArrayOfVector)
	ACPH_ADD_ATTRIBUTE(TestSerializable, mVectorOfVector)
	ACPH_ADD_ATTRIBUTE(TestSerializable, mPointer)
	ACPH_ADD_ATTRIBUTE(TestSerializable, mReference)
	ACPH_ADD_ATTRIBUTE(TestSerializable, mReferenceConst)
}
...
TEST_SUITE("ObjectStreamTest")
{
	...
	{
		Factory::sInstance->Register(ACPH_RTTI(TestSerializable));
