...
TEST_SUITE("Mat44Tests")
{
	...
	{
		Mat44 rot = Mat44::sRotationX(0.5f * ACPH_PI);
		...
		rot = Mat44::sRotationY(0.5f * ACPH_PI);
		v = rot * Vec3(1, 0, 0);
		CHECK_APPROX_EQUAL(v, Vec3(0, 0, -1));
		v = rot * Vec3(0, 1, 0);
		CHECK(v == Vec3(0, 1, 0));
		...
		rot = Mat44::sRotationZ(0.5f * ACPH_PI);
		v = rot * Vec3(1, 0, 0);
		CHECK_APPROX_EQUAL(v, Vec3(0, 1, 0));
		v = rot * Vec3(0, 1, 0);
		CHECK_APPROX_EQUAL(v, Vec3(-1, 0, 0));
	...
	{
		Mat44 r1 = Mat44::sRotationX(0.1f * ACPH_PI);
		Mat44 r2 = Mat44::sRotation(Vec3(1, 0, 0), 0.1f * ACPH_PI);
		CHECK_APPROX_EQUAL(r1, r2);

		r1 = Mat44::sRotationY(0.2f * ACPH_PI);
		r2 = Mat44::sRotation(Vec3(0, 1, 0), 0.2f * ACPH_PI);
		CHECK_APPROX_EQUAL(r1, r2);

		r1 = Mat44::sRotationZ(0.3f * ACPH_PI);
		r2 = Mat44::sRotation(Vec3(0, 0, 1), 0.3f * ACPH_PI);
		CHECK_APPROX_EQUAL(r1, r2);
	}
	...
	{
		Quat rot = Quat::sRotation(Vec3(0, 1, 0), 0.2f * ACPH_PI);
		Vec3 pos(2, 3, 4);
	...
	{
		Mat44 rotation = Mat44::sRotationX(0.1f * ACPH_PI) * Mat44::sRotationZ(0.2f * ACPH_PI);
	...
	TEST_CASE("TestMat44Decompose")
	{
		...
		Quat rot = Quat::sRotation(Vec3(1, 1, 1).Normalized(), 0.2f * ACPH_PI);
		Vec3 pos(2, 3, 4);
