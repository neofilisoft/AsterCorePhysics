...
TEST_SUITE("CollideShapeTests")
{
	...
	TEST_CASE("TestCollideShapeSphere")
	{
		...
		RMat44 shape1_transform = RMat44::sTranslation(cPosition1A) * Mat44::sRotationX(0.1f * ACPH_PI) * shape1_com;
		...
		c.GetSystem()->GetBodyInterface().SetPositionAndRotation(body2.GetID(), cPosition2B, Quat::sRotation(Vec3::sAxisY(), 0.2f * ACPH_PI), EActivation::DontActivate);
		...
		shape1_transform = RMat44::sTranslation(cPosition1B) * Mat44::sRotationZ(0.3f * ACPH_PI) * shape1_com;
	...
	TEST_CASE("TestCollideShapeSphereVsBox")
	{
		...
		Body &body2 = c.CreateBody(&scaled_box, RVec3(0, 1, 0), Quat::sRotation(Vec3::sAxisZ(), 0.5f * ACPH_PI), EMotionType::Static, EMotionQuality::Discrete, Layers::NON_MOVING, EActivation::DontActivate);
