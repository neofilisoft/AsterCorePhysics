...
#include <AsterCore/Physics/Collision/CollideShapeVsShapePerLeaf.h>
...
TEST_SUITE("SensorTests")
{
	...
	TEST_CASE("TestContactListenerMakesSensor")
	{
		...
		public:
			virtual void		OnContactAdded(const Body &inBody1, const Body &inBody2, const ContactManifold &inManifold, ContactSettings &ioSettings) override
			{
				...
				ACPH_ASSERT(ioSettings.mIsSensor == false);
	...
	TEST_CASE("TestSensorVsSubShapes")
	{
		...
		BodyCreationSettings compound_body_settings(shape_settings, RVec3(0, 20, 0), Quat::sIdentity(), ACPH::EMotionType::Dynamic, Layers::MOVING);
		...
		ACPH::BodyID compound_body = bi.CreateAndAddBody(compound_body_settings, ACPH::EActivation::Activate);
