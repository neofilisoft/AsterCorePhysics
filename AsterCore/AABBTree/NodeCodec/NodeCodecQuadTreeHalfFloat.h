...
#include <AsterCore/Math/HalfFloat.h>
...
public:
	...
	public:
		...
		/// Constructor
		ACPH_INLINE explicit			DecodingContext(const Header *inHeader)
		{
		...
		ACPH_INLINE void				WalkTree(const uint8 *inBufferStart, const TriangleContext &inTriangleContext, Visitor &ioVisitor)
		{
			do
			{
