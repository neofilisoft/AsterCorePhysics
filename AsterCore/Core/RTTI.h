...
#include <AsterCore/Core/StaticArray.h>
...
///		class Foo
///		{
///			ACPH_DECLARE_RTTI_VIRTUAL_BASE(Foo)
///		}
///
///		class Bar : public Foo
///		{
///			ACPH_DECLARE_RTTI_VIRTUAL(Bar)
///		};
///
/// Implementation file:
///
///		ACPH_IMPLEMENT_RTTI_VIRTUAL_BASE(Foo)
///		{
///		}
///
///		ACPH_IMPLEMENT_RTTI_VIRTUAL(Bar)
///		{
///			ACPH_ADD_BASE_CLASS(Bar, Foo) // Multiple inheritance is allowed, just do ACPH_ADD_BASE_CLASS for every base class
///		}
///
...
///		class Foo
///		{
///			ACPH_DECLARE_RTTI_ABSTRACT_BASE(Foo)
///
///		public:
...
/// Implementation file:
///
///		ACPH_IMPLEMENT_RTTI_ABSTRACT_BASE(Foo)
///		{
///		}
///
///		ACPH_IMPLEMENT_RTTI_VIRTUAL(Bar)
///		{
///			ACPH_ADD_BASE_CLASS(Bar, Foo)
///		}
///
...
// ACPH_DECLARE_RTTI_NON_VIRTUAL
#define ACPH_DECLARE_RTTI_NON_VIRTUAL(linkage, class_name)															\
public:																												\
...
// ACPH_IMPLEMENT_RTTI_NON_VIRTUAL
#define ACPH_IMPLEMENT_RTTI_NON_VIRTUAL(class_name)																	\
...
// ACPH_DECLARE_RTTI_OUTSIDE_CLASS
#define ACPH_DECLARE_RTTI_OUTSIDE_CLASS(linkage, class_name)															\
...
// ACPH_IMPLEMENT_RTTI_OUTSIDE_CLASS
#define ACPH_IMPLEMENT_RTTI_OUTSIDE_CLASS(class_name)																\
	RTTI *						GetRTTIOfType(class_name *)															\
	{																												\
...
#define ACPH_DECLARE_RTTI_HELPER(linkage, class_name, modifier)														\
public:																												\
	ACPH_OVERRIDE_NEW_DELETE																							\
	friend linkage RTTI *		GetRTTIOfType(class_name *);														\
...
// ACPH_DECLARE_RTTI_VIRTUAL - for derived classes with RTTI
#define ACPH_DECLARE_RTTI_VIRTUAL(linkage, class_name)																\
	ACPH_DECLARE_RTTI_HELPER(linkage, class_name, override)

// ACPH_IMPLEMENT_RTTI_VIRTUAL
#define ACPH_IMPLEMENT_RTTI_VIRTUAL(class_name)																		\
	RTTI *			GetRTTIOfType(class_name *)																		\
	{																												\
		static RTTI rtti(#class_name, sizeof(class_name), []() -> void * { return new class_name; }, [](void *inObject) { delete (class_name *)inObject; }, &class_name::sCreateRTTI); \
		return &rtti;																								\
	...
	{																												\
		return ACPH_RTTI(class_name);																				\
	}																												\
	const void *				class_name::CastTo(const RTTI *inRTTI) const										\
	{																												\
		return ACPH_RTTI(class_name)->CastTo((const void *)this, inRTTI);											\
	}																												\
	void						class_name::sCreateRTTI(RTTI &inRTTI)												\

// ACPH_DECLARE_RTTI_VIRTUAL_BASE - for concrete base class that has RTTI
#define ACPH_DECLARE_RTTI_VIRTUAL_BASE(linkage, class_name)															\
	ACPH_DECLARE_RTTI_HELPER(linkage, class_name, )

// ACPH_IMPLEMENT_RTTI_VIRTUAL_BASE
#define ACPH_IMPLEMENT_RTTI_VIRTUAL_BASE(class_name)																	\
	ACPH_IMPLEMENT_RTTI_VIRTUAL(class_name)

// ACPH_DECLARE_RTTI_ABSTRACT - for derived abstract class that have RTTI
#define ACPH_DECLARE_RTTI_ABSTRACT(linkage, class_name)																\
	ACPH_DECLARE_RTTI_HELPER(linkage, class_name, override)

// ACPH_IMPLEMENT_RTTI_ABSTRACT
#define ACPH_IMPLEMENT_RTTI_ABSTRACT(class_name)																		\
	RTTI *						GetRTTIOfType(class_name *)															\
	{																												\
...
// ACPH_DECLARE_RTTI_ABSTRACT_BASE - for abstract base class that has RTTI
#define ACPH_DECLARE_RTTI_ABSTRACT_BASE(linkage, class_name)															\
	ACPH_DECLARE_RTTI_HELPER(linkage, class_name, )

// ACPH_IMPLEMENT_RTTI_ABSTRACT_BASE
#define ACPH_IMPLEMENT_RTTI_ABSTRACT_BASE(class_name)																\
...
#define ACPH_DECLARE_RTTI_FOR_FACTORY(linkage, class_name)															\
	linkage RTTI *				GetRTTIOfType(class class_name *);

#define ACPH_DECLARE_RTTI_WITH_NAMESPACE_FOR_FACTORY(linkage, name_space, class_name)								\
...
#define ACPH_RTTI(class_name)	GetRTTIOfType(static_cast<class_name *>(nullptr))
...
// class A { class B { }; }
//
// Now use ACPH_RENAME_CLASS(B, A::B) to avoid conflicts with other classes named B
//////////////////////////////////////////////////////////////////////////////////////////

// ACPH_RENAME_CLASS
#define ACPH_RENAME_CLASS(class_name, new_name)																		\
...
#define ACPH_BASE_CLASS_OFFSET(inClass, inBaseClass)	((int(uint64((inBaseClass *)((inClass *)0x10000))))-0x10000)

// ACPH_ADD_BASE_CLASS
#define ACPH_ADD_BASE_CLASS(class_name, base_class_name)																\
								inRTTI.AddBaseClass(ACPH_RTTI(base_class_name), ACPH_BASE_CLASS_OFFSET(class_name, base_class_name));
...
{
	return inObject != nullptr? reinterpret_cast<const DstType *>(inObject->CastTo(ACPH_RTTI(DstType))) : nullptr;
}

template <class DstType, class SrcType>
inline DstType *DynamicCast(SrcType *inObject)
{
	return inObject != nullptr? const_cast<DstType *>(reinterpret_cast<const DstType *>(inObject->CastTo(ACPH_RTTI(DstType)))) : nullptr;
}
