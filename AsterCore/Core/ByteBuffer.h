...
#include <AsterCore/Core/STLAlignedAllocator.h>

ACPH_NAMESPACE_BEGIN

/// Underlying data type for ByteBuffer
using ByteBufferVector = Array<uint8, STLAlignedAllocator<uint8, ACPH_CACHE_LINE_SIZE>>;
