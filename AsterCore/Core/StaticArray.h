...
namespace std
{
	...
	template <class T, ACPH::uint N>
	struct hash<ACPH::StaticArray<T, N>>
	{
		size_t operator () (const ACPH::StaticArray<T, N> &inRHS) const
		{
