...
#include <AsterCore/Core/FixedSizeFreeList.h>
...
class ACPH_EXPORT JobSystemThreadPool final : public JobSystemWithBarrier
{
public:
...
private:
	...
	alignas(ACPH_CACHE_LINE_SIZE) atomic<uint> mTail = 0;					///< Tail (write end) of the queue
