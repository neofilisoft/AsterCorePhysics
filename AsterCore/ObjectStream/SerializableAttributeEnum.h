...
// ACPH_ADD_ENUM_ATTRIBUTE_WITH_ALIAS
#define ACPH_ADD_ENUM_ATTRIBUTE_WITH_ALIAS(class_name, member_name, alias_name) \
	AddSerializableAttributeEnum<decltype(class_name::member_name)>(inRTTI, offsetof(class_name, member_name), alias_name);

// ACPH_ADD_ENUM_ATTRIBUTE
#define ACPH_ADD_ENUM_ATTRIBUTE(class_name, member_name) \
	ACPH_ADD_ENUM_ATTRIBUTE_WITH_ALIAS(class_name, member_name, #member_name);

ACPH_NAMESPACE_END

#else

#define ACPH_ADD_ENUM_ATTRIBUTE_WITH_ALIAS(...)
#define ACPH_ADD_ENUM_ATTRIBUTE(...)
