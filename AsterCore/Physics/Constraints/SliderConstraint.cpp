...
ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(SliderConstraintSettings)
{
	ACPH_ADD_BASE_CLASS(SliderConstraintSettings, TwoBodyConstraintSettings)

	ACPH_ADD_ENUM_ATTRIBUTE(SliderConstraintSettings, mSpace)
	ACPH_ADD_ATTRIBUTE(SliderConstraintSettings, mAutoDetectPoint)
	ACPH_ADD_ATTRIBUTE(SliderConstraintSettings, mPoint1)
	ACPH_ADD_ATTRIBUTE(SliderConstraintSettings, mSliderAxis1)
	ACPH_ADD_ATTRIBUTE(SliderConstraintSettings, mNormalAxis1)
	ACPH_ADD_ATTRIBUTE(SliderConstraintSettings, mPoint2)
	ACPH_ADD_ATTRIBUTE(SliderConstraintSettings, mSliderAxis2)
	ACPH_ADD_ATTRIBUTE(SliderConstraintSettings, mNormalAxis2)
	ACPH_ADD_ATTRIBUTE(SliderConstraintSettings, mLimitsMin)
	ACPH_ADD_ATTRIBUTE(SliderConstraintSettings, mLimitsMax)
	ACPH_ADD_ENUM_ATTRIBUTE_WITH_ALIAS(SliderConstraintSettings, mLimitsSpringSettings.mMode, "mSpringMode")
	ACPH_ADD_ATTRIBUTE_WITH_ALIAS(SliderConstraintSettings, mLimitsSpringSettings.mFrequency, "mFrequency") // Renaming attributes to stay compatible with old versions of the library
	ACPH_ADD_ATTRIBUTE_WITH_ALIAS(SliderConstraintSettings, mLimitsSpringSettings.mDamping, "mDamping")
	ACPH_ADD_ATTRIBUTE(SliderConstraintSettings, mMaxFrictionForce)
	ACPH_ADD_ATTRIBUTE(SliderConstraintSettings, mMotorSettings)
}

void SliderConstraintSettings::SetSliderAxis(Vec3Arg inSliderAxis)
{
	ACPH_ASSERT(mSpace == EConstraintSpace::WorldSpace);
	...
	mMotorSettings(inSettings.mMotorSettings)
{
	...
	// Store limits
	ACPH_ASSERT(inSettings.mLimitsMin != inSettings.mLimitsMax || inSettings.mLimitsSpringSettings.mFrequency > 0.0f, "Better use a fixed constraint");
...
{
	ACPH_ASSERT(inLimitsMin <= 0.0f);
	ACPH_ASSERT(inLimitsMax >= 0.0f);
