...
class ACPH_EXPORT DistanceConstraintSettings final : public TwoBodyConstraintSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, DistanceConstraintSettings)
...
class ACPH_EXPORT DistanceConstraint final : public TwoBodyConstraint
{
public:
	...
	void						SetDistance(float inMinDistance, float inMaxDistance)		{ ACPH_ASSERT(inMinDistance <= inMaxDistance); mMinDistance = inMinDistance; mMaxDistance = inMaxDistance; }
