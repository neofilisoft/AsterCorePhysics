...
class ACPH_EXPORT FixedConstraintSettings final : public TwoBodyConstraintSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, FixedConstraintSettings)
...
class ACPH_EXPORT FixedConstraint final : public TwoBodyConstraint
{
public:
