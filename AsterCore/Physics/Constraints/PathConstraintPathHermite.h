...
class ACPH_EXPORT PathConstraintPathHermite final : public PathConstraintPath
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, PathConstraintPathHermite)
...
public:
	...
	struct Point
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, Point)
