...
ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(SwingTwistConstraintSettings)
{
	ACPH_ADD_BASE_CLASS(SwingTwistConstraintSettings, TwoBodyConstraintSettings)

	ACPH_ADD_ENUM_ATTRIBUTE(SwingTwistConstraintSettings, mSpace)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mPosition1)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mTwistAxis1)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mPlaneAxis1)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mPosition2)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mTwistAxis2)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mPlaneAxis2)
	ACPH_ADD_ENUM_ATTRIBUTE(SwingTwistConstraintSettings, mSwingType)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mNormalHalfConeAngle)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mPlaneHalfConeAngle)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mTwistMinAngle)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mTwistMaxAngle)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mMaxFrictionTorque)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mSwingMotorSettings)
	ACPH_ADD_ATTRIBUTE(SwingTwistConstraintSettings, mTwistMotorSettings)
}
...
{
	ACPH_ASSERT(inState == EMotorState::Off || mSwingMotorSettings.IsValid());
...
{
	ACPH_ASSERT(inState == EMotorState::Off || mTwistMotorSettings.IsValid());
...
bool SwingTwistConstraint::SolveVelocityConstraint(float inDeltaTime)
{
	...
	if (mMotorConstraintPart[1].IsActive())
	{
		...
		ACPH_ASSERT(mMotorConstraintPart[2].IsActive());
