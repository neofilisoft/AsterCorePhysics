...
ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(PulleyConstraintSettings)
{
	ACPH_ADD_BASE_CLASS(PulleyConstraintSettings, TwoBodyConstraintSettings)

	ACPH_ADD_ENUM_ATTRIBUTE(PulleyConstraintSettings, mSpace)
	ACPH_ADD_ATTRIBUTE(PulleyConstraintSettings, mBodyPoint1)
	ACPH_ADD_ATTRIBUTE(PulleyConstraintSettings, mFixedPoint1)
	ACPH_ADD_ATTRIBUTE(PulleyConstraintSettings, mBodyPoint2)
	ACPH_ADD_ATTRIBUTE(PulleyConstraintSettings, mFixedPoint2)
	ACPH_ADD_ATTRIBUTE(PulleyConstraintSettings, mRatio)
	ACPH_ADD_ATTRIBUTE(PulleyConstraintSettings, mMinLength)
	ACPH_ADD_ATTRIBUTE(PulleyConstraintSettings, mMaxLength)
}
