...
class ACPH_EXPORT PathConstraintPath : public SerializableObject, public RefTarget<PathConstraintPath>
{
	ACPH_DECLARE_SERIALIZABLE_ABSTRACT(ACPH_EXPORT, PathConstraintPath)
