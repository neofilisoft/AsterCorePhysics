...
class ACPH_EXPORT ConstraintManager : public NonCopyable
{
public:
	...
	void					LockAllConstraints()						{ PhysicsLock::sLock(mConstraintsMutex ACPH_IF_ENABLE_ASSERTS(, mLockContext, EPhysicsLockTypes::ConstraintsList)); }
	void					UnlockAllConstraints()						{ PhysicsLock::sUnlock(mConstraintsMutex ACPH_IF_ENABLE_ASSERTS(, mLockContext, EPhysicsLockTypes::ConstraintsList)); }
