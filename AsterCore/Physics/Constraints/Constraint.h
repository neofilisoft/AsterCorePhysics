...
class ACPH_EXPORT ConstraintSettings : public SerializableObject, public RefTarget<ConstraintSettings>
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, ConstraintSettings)
...
class ACPH_EXPORT Constraint : public RefTarget<Constraint>, public NonCopyable
{
public:
	...
	{
		ACPH_ASSERT(inSettings.mNumVelocityStepsOverride < 256);
		ACPH_ASSERT(inSettings.mNumPositionStepsOverride < 256);
	}
