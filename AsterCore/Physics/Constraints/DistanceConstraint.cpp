...
ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(DistanceConstraintSettings)
{
	ACPH_ADD_BASE_CLASS(DistanceConstraintSettings, TwoBodyConstraintSettings)

	ACPH_ADD_ENUM_ATTRIBUTE(DistanceConstraintSettings, mSpace)
	ACPH_ADD_ATTRIBUTE(DistanceConstraintSettings, mPoint1)
	ACPH_ADD_ATTRIBUTE(DistanceConstraintSettings, mPoint2)
	ACPH_ADD_ATTRIBUTE(DistanceConstraintSettings, mMinDistance)
	ACPH_ADD_ATTRIBUTE(DistanceConstraintSettings, mMaxDistance)
	ACPH_ADD_ENUM_ATTRIBUTE_WITH_ALIAS(DistanceConstraintSettings, mLimitsSpringSettings.mMode, "mSpringMode")
	ACPH_ADD_ATTRIBUTE_WITH_ALIAS(DistanceConstraintSettings, mLimitsSpringSettings.mFrequency, "mFrequency") // Renaming attributes to stay compatible with old versions of the library
	ACPH_ADD_ATTRIBUTE_WITH_ALIAS(DistanceConstraintSettings, mLimitsSpringSettings.mDamping, "mDamping")
}
