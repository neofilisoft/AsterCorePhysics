...
class ACPH_EXPORT ConeConstraintSettings final : public TwoBodyConstraintSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, ConeConstraintSettings)
...
class ACPH_EXPORT ConeConstraint final : public TwoBodyConstraint
{
public:
	...
	void						SetHalfConeAngle(float inHalfConeAngle)		{ ACPH_ASSERT(inHalfConeAngle >= 0.0f && inHalfConeAngle <= ACPH_PI); mCosHalfConeAngle = Cos(inHalfConeAngle); }
