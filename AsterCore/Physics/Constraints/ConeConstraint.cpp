...
ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(ConeConstraintSettings)
{
	ACPH_ADD_BASE_CLASS(ConeConstraintSettings, TwoBodyConstraintSettings)

	ACPH_ADD_ENUM_ATTRIBUTE(ConeConstraintSettings, mSpace)
	ACPH_ADD_ATTRIBUTE(ConeConstraintSettings, mPoint1)
	ACPH_ADD_ATTRIBUTE(ConeConstraintSettings, mTwistAxis1)
	ACPH_ADD_ATTRIBUTE(ConeConstraintSettings, mPoint2)
	ACPH_ADD_ATTRIBUTE(ConeConstraintSettings, mTwistAxis2)
	ACPH_ADD_ATTRIBUTE(ConeConstraintSettings, mHalfConeAngle)
}
