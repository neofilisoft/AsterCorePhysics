...
#include <AsterCore/Physics/Constraints/ConstraintPart/RackAndPinionConstraintPart.h>

ACPH_NAMESPACE_BEGIN

/// Rack and pinion constraint (slider & gear) settings
class ACPH_EXPORT RackAndPinionConstraintSettings final : public TwoBodyConstraintSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, RackAndPinionConstraintSettings)
...
public:
	...
	{
		mRatio = 2.0f * ACPH_PI * inNumTeethRack / (inRackLength * inNumTeethPinion);
	}
...
class ACPH_EXPORT RackAndPinionConstraint final : public TwoBodyConstraint
{
public:
