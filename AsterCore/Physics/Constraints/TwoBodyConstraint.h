...
class ACPH_EXPORT TwoBodyConstraintSettings : public ConstraintSettings
{
	ACPH_DECLARE_SERIALIZABLE_ABSTRACT(ACPH_EXPORT, TwoBodyConstraintSettings)
...
class ACPH_EXPORT TwoBodyConstraint : public Constraint
{
public:
