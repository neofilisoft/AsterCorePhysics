...
#include <AsterCore/Physics/Constraints/ConstraintPart/GearConstraintPart.h>

ACPH_NAMESPACE_BEGIN

/// Gear constraint settings
class ACPH_EXPORT GearConstraintSettings final : public TwoBodyConstraintSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, GearConstraintSettings)
...
class ACPH_EXPORT GearConstraint final : public TwoBodyConstraint
{
public:
