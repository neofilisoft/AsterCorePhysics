...
ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(PointConstraintSettings)
{
	ACPH_ADD_BASE_CLASS(PointConstraintSettings, TwoBodyConstraintSettings)

	ACPH_ADD_ENUM_ATTRIBUTE(PointConstraintSettings, mSpace)
	ACPH_ADD_ATTRIBUTE(PointConstraintSettings, mPoint1)
	ACPH_ADD_ATTRIBUTE(PointConstraintSettings, mPoint2)
}
