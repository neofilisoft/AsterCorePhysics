...
class ACPH_EXPORT PointConstraintSettings final : public TwoBodyConstraintSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, PointConstraintSettings)
...
class ACPH_EXPORT PointConstraint final : public TwoBodyConstraint
{
public:
