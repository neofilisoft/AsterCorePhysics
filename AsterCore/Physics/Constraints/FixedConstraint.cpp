...
ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(FixedConstraintSettings)
{
	ACPH_ADD_BASE_CLASS(FixedConstraintSettings, TwoBodyConstraintSettings)

	ACPH_ADD_ENUM_ATTRIBUTE(FixedConstraintSettings, mSpace)
	ACPH_ADD_ATTRIBUTE(FixedConstraintSettings, mAutoDetectPoint)
	ACPH_ADD_ATTRIBUTE(FixedConstraintSettings, mPoint1)
	ACPH_ADD_ATTRIBUTE(FixedConstraintSettings, mAxisX1)
	ACPH_ADD_ATTRIBUTE(FixedConstraintSettings, mAxisY1)
	ACPH_ADD_ATTRIBUTE(FixedConstraintSettings, mPoint2)
	ACPH_ADD_ATTRIBUTE(FixedConstraintSettings, mAxisX2)
	ACPH_ADD_ATTRIBUTE(FixedConstraintSettings, mAxisY2)
}
