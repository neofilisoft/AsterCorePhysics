...
class ACPH_EXPORT SwingTwistConstraintSettings final : public TwoBodyConstraintSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, SwingTwistConstraintSettings)
...
class ACPH_EXPORT SwingTwistConstraint final : public TwoBodyConstraint
{
public:
