...
class ACPH_EXPORT SliderConstraintSettings final : public TwoBodyConstraintSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, SliderConstraintSettings)
...
class ACPH_EXPORT SliderConstraint final : public TwoBodyConstraint
{
public:
