...
#include <AsterCore/Physics/Constraints/ConstraintPart/PointConstraintPart.h>
#include <AsterCore/Physics/Constraints/ConstraintPart/AxisConstraintPart.h>
#include <AsterCore/Physics/Constraints/ConstraintPart/AngleConstraintPart.h>
#include <AsterCore/Physics/Constraints/ConstraintPart/RotationEulerConstraintPart.h>
#include <AsterCore/Physics/Constraints/ConstraintPart/SwingTwistConstraintPart.h>

ACPH_NAMESPACE_BEGIN

/// 6 Degree Of Freedom Constraint setup structure. Allows control over each of the 6 degrees of freedom.
class ACPH_EXPORT SixDOFConstraintSettings final : public TwoBodyConstraintSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, SixDOFConstraintSettings)
...
class ACPH_EXPORT SixDOFConstraint final : public TwoBodyConstraint
{
public:
	...
	const SpringSettings &		GetLimitsSpringSettings(EAxis inAxis) const					{ ACPH_ASSERT(inAxis < EAxis::NumTranslation); return mLimitsSpringSettings[inAxis]; }
	void						SetLimitsSpringSettings(EAxis inAxis, const SpringSettings& inLimitsSpringSettings) { ACPH_ASSERT(inAxis < EAxis::NumTranslation); mLimitsSpringSettings[inAxis] = inLimitsSpringSettings; CacheHasSpringLimits(); }
