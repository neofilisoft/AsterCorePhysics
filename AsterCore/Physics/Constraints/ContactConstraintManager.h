...
#include <AsterCore/Core/LockFreeHashMap.h>
#include <AsterCore/Physics/EPhysicsUpdateError.h>
#include <AsterCore/Physics/Body/BodyPair.h>
#include <AsterCore/Physics/Collision/Shape/SubShapeIDPair.h>
#include <AsterCore/Physics/Collision/ManifoldBetweenTwoFaces.h>
#include <AsterCore/Physics/Constraints/ConstraintPart/AxisConstraintPart.h>
#include <AsterCore/Physics/Constraints/ConstraintPart/DualAxisConstraintPart.h>
...
class ACPH_EXPORT ContactConstraintManager : public NonCopyable
{
public:
...
private:
	...
	public:
		...
		ACPH_INLINE Vec3			GetWorldSpaceNormal() const
		{
			return Vec3::sLoadFloat3Unsafe(mWorldSpaceNormal);
		}

		/// Get the tangents for this contact constraint
		ACPH_INLINE void			GetTangents(Vec3 &outTangent1, Vec3 &outTangent2) const
		{
...
private:
	...
	template <EMotionType Type1, EMotionType Type2>
	ACPH_INLINE void				TemplatedCalculateFrictionAndNonPenetrationConstraintProperties(ContactConstraint &ioConstraint, const ContactSettings &inSettings, float inDeltaTime, Vec3Arg inGravityDeltaTime, RMat44Arg inTransformBody1, RMat44Arg inTransformBody2, const Body &inBody1, const Body &inBody2);
	...
	template <EMotionType Type1, EMotionType Type2>
	ACPH_INLINE static void		sWarmStartConstraint(ContactConstraint &ioConstraint, MotionProperties *ioMotionProperties1, MotionProperties *ioMotionProperties2, float inWarmStartImpulseRatio);
	...
	template <EMotionType Type1, EMotionType Type2>
	ACPH_INLINE static bool		sSolveVelocityConstraint(ContactConstraint &ioConstraint, MotionProperties *ioMotionProperties1, MotionProperties *ioMotionProperties2);
