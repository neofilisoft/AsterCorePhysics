...
class ACPH_EXPORT SoftBodySharedSettings : public RefTarget<SoftBodySharedSettings>
{
	ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, SoftBodySharedSettings)
...
public:
	...
	struct ACPH_EXPORT VertexAttributes
	{
		/// Constructor
	...
	struct ACPH_EXPORT Vertex
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, Vertex)
	...
	struct ACPH_EXPORT Face
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, Face)
	...
	struct ACPH_EXPORT Edge
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, Edge)
	 ...
	 */
	struct ACPH_EXPORT DihedralBend
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, DihedralBend)
	...
	struct ACPH_EXPORT Volume
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, Volume)
	...
	class ACPH_EXPORT InvBind
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, InvBind)
	...
	class ACPH_EXPORT SkinWeight
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, SkinWeight)
	...
	class ACPH_EXPORT Skinned
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, Skinned)
	...
	class ACPH_EXPORT LRA
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, LRA)
	...
	struct ACPH_EXPORT RodStretchShear
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, RodStretchShear)
	...
	struct ACPH_EXPORT RodBendTwist
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, RodBendTwist)
	...
	void				AddFace(const Face &inFace)					{ ACPH_ASSERT(!inFace.IsDegenerate()); mFaces.push_back(inFace); }
