...
#include <AsterCore/Physics/SoftBody/SoftBodyVertex.h>
...
class ACPH_EXPORT SoftBodyMotionProperties : public MotionProperties
{
public:
	...
	void								SetVertexRadius(float inVertexRadius)		{ ACPH_ASSERT(mVertexRadius >= 0.0f); mVertexRadius = inVertexRadius; }
