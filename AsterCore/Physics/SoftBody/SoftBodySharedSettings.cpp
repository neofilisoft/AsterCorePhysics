...
#include <AsterCore/Physics/SoftBody/SoftBodyUpdateContext.h>
#include <AsterCore/ObjectStream/TypeDeclarations.h>
#include <AsterCore/Core/StreamIn.h>
#include <AsterCore/Core/StreamOut.h>
#include <AsterCore/Core/QuickSort.h>
#include <AsterCore/Core/UnorderedMap.h>
#include <AsterCore/Core/UnorderedSet.h>
#include <AsterCore/Core/BinaryHeap.h>

ACPH_NAMESPACE_BEGIN

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings::Vertex)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Vertex, mPosition)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Vertex, mVelocity)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Vertex, mInvMass)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings::Face)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Face, mVertex)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Face, mMaterialIndex)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings::Edge)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Edge, mVertex)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Edge, mRestLength)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Edge, mCompliance)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings::RodStretchShear)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::RodStretchShear, mVertex)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::RodStretchShear, mLength)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::RodStretchShear, mInvMass)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::RodStretchShear, mCompliance)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::RodStretchShear, mBishop)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings::RodBendTwist)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::RodBendTwist, mRod)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::RodBendTwist, mCompliance)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::RodBendTwist, mOmega0)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings::DihedralBend)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::DihedralBend, mVertex)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::DihedralBend, mCompliance)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::DihedralBend, mInitialAngle)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings::Volume)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Volume, mVertex)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Volume, mSixRestVolume)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Volume, mCompliance)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings::InvBind)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::InvBind, mJointIndex)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::InvBind, mInvBind)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings::SkinWeight)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::SkinWeight, mInvBindIndex)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::SkinWeight, mWeight)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings::Skinned)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Skinned, mVertex)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Skinned, mWeights)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Skinned, mMaxDistance)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Skinned, mBackStopDistance)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::Skinned, mBackStopRadius)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings::LRA)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::LRA, mVertex)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings::LRA, mMaxDistance)
}

ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(SoftBodySharedSettings)
{
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings, mVertices)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings, mFaces)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings, mEdgeConstraints)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings, mDihedralBendConstraints)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings, mVolumeConstraints)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings, mSkinnedConstraints)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings, mInvBindMatrices)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings, mLRAConstraints)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings, mRodStretchShearConstraints)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings, mRodBendTwistConstraints)
	ACPH_ADD_ATTRIBUTE(SoftBodySharedSettings, mMaterials)
}
...
void SoftBodySharedSettings::CalculateClosestKinematic()
{
	...
	ACPH_IF_ENABLE_ASSERTS(float last_closest = 0.0f;)
	while (!to_visit.empty())
	{
		...
		to_visit.pop_back();
		ACPH_ASSERT(current.mDistance >= last_closest);
		ACPH_IF_ENABLE_ASSERTS(last_closest = current.mDistance;)
...
void SoftBodySharedSettings::CreateConstraints(const VertexAttributes *inVertexAttributes, uint inVertexAttributesLength, EBendType inBendType, float inAngleTolerance)
{
	...
	auto add_edge = [this](uint32 inVtx1, uint32 inVtx2, float inCompliance1, float inCompliance2) {
			...
			&& inCompliance1 < FLT_MAX && inCompliance2 < FLT_MAX)
		{
			...
			ACPH_ASSERT(temp_edge.mRestLength > 0.0f);
...
void SoftBodySharedSettings::CalculateEdgeLengths()
{
	...
	{
		ACPH_ASSERT(e.mVertex[0] != e.mVertex[1], "Edges need to connect 2 different vertices");
		e.mRestLength = (Vec3(mVertices[e.mVertex[1]].mPosition) - Vec3(mVertices[e.mVertex[0]].mPosition)).Length();
		ACPH_ASSERT(e.mRestLength > 0.0f);
	}
}
...
void SoftBodySharedSettings::CalculateRodProperties()
{
	...
	{
		ACPH_ASSERT(c.mRod[0] != c.mRod[1], "A bend twist constraint needs to be attached to different rods");
	...
	for (uint32 r0_idx = 0; r0_idx < mRodStretchShearConstraints.size(); ++r0_idx)
	{
		...
		if (r0.mBishop == Quat::sZero())
		{
			// Calculate the frame for this rod
			{
				...
				ACPH_ASSERT(r0.mLength > 0.0f, "Rods of zero length are not supported!");
				tangent /= r0.mLength;
			...
			while (!stack.empty())
			{
				...
				ACPH_ASSERT(r2.mLength > 0.0f, "Rods of zero length are not supported!");
				tangent2 /= r2.mLength;
	...
	{
		ACPH_ASSERT(r.mVertex[0] != r.mVertex[1], "A rod stretch shear constraint requires two different vertices");
...
void SoftBodySharedSettings::CalculateLRALengths(float inMaxDistanceMultiplier)
{
	...
	{
		ACPH_ASSERT(l.mVertex[0] != l.mVertex[1], "LRA constraints need to connect 2 different vertices");
		l.mMaxDistance = inMaxDistanceMultiplier * (Vec3(mVertices[l.mVertex[1]].mPosition) - Vec3(mVertices[l.mVertex[0]].mPosition)).Length();
		ACPH_ASSERT(l.mMaxDistance > 0.0f);
	}
}
...
void SoftBodySharedSettings::CalculateBendConstraintConstants()
{
	...
	{
		ACPH_ASSERT(b.mVertex[0] != b.mVertex[1] && b.mVertex[0] != b.mVertex[2] && b.mVertex[0] != b.mVertex[3]
...
void SoftBodySharedSettings::CalculateVolumeConstraintVolumes()
{
	...
	{
		ACPH_ASSERT(v.mVertex[0] != v.mVertex[1] && v.mVertex[0] != v.mVertex[2] && v.mVertex[0] != v.mVertex[3]
...
void SoftBodySharedSettings::Optimize(OptimizationResults &outResults)
{
	...
	for (const RodBendTwist &r : mRodBendTwistConstraints)
	{
		...
		ACPH_ASSERT(g1 >= 0 && g2 >= 0 && g3 >= 0 && g4 >= 0);
