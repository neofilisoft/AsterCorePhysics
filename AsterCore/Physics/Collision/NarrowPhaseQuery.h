...
#include <AsterCore/Physics/Body/BodyLockInterface.h>
#include <AsterCore/Physics/Collision/ShapeFilter.h>
#include <AsterCore/Physics/Collision/BroadPhase/BroadPhaseQuery.h>
...
class ACPH_EXPORT NarrowPhaseQuery : public NonCopyable
{
public:
