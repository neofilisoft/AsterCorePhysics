...
#include <AsterCore/Core/STLLocalAllocator.h>
#include <AsterCore/Physics/Collision/CollisionDispatch.h>

//#define ACPH_INTERNAL_EDGE_REMOVING_COLLECTOR_DEBUG
...
public:
	...
	{
		ACPH_ASSERT(inCollideShapeSettings.mActiveEdgeMode == EActiveEdgeMode::CollideWithAll); // Won't work without colliding with all edges
		ACPH_ASSERT(inCollideShapeSettings.mCollectFacesMode == ECollectFacesMode::CollectFaces); // Won't work without collecting faces
