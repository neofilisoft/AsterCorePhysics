...
#include <AsterCore/Physics/Collision/CollisionCollector.h>
...
public:
	...
	virtual void		OnBodyEnd() override
	{
		if (mHadHit)
		{
			...
			ACPH_ASSERT(mPreviousEarlyOutFraction != -FLT_MAX); // Check that we got a call to OnBody
		...
		ACPH_IF_ENABLE_ASSERTS(mPreviousEarlyOutFraction = -FLT_MAX;)
	}
