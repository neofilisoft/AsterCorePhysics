...
#include <AsterCore/Physics/Collision/Shape/ConvexShape.h>
...
#endif
ACPH_EXPORT void PruneContactPoints(Vec3Arg inPenetrationAxis, ContactPoints &ioContactPointsOn1, ContactPoints &ioContactPointsOn2
#ifdef ACPH_DEBUG_RENDERER
...
/// @param inCenterOfMass Center of mass position of body 1
#endif
ACPH_EXPORT void ManifoldBetweenTwoFaces(Vec3Arg inContactPoint1, Vec3Arg inContactPoint2, Vec3Arg inPenetrationAxis, float inMaxContactDistance, const ConvexShape::SupportingFace &inShape1Face, const ConvexShape::SupportingFace &inShape2Face, ContactPoints &outContactPoints1, ContactPoints &outContactPoints2
#ifdef ACPH_DEBUG_RENDERER
	, RVec3Arg inCenterOfMass
#endif
	);
