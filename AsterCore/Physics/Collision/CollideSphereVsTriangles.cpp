...
#include <AsterCore/Physics/Collision/ActiveEdges.h>
	...
	mSubShapeID1(inSubShapeID1)
{
	...
	ACPH_ASSERT(ScaleHelpers::IsUniformScale(inScale1.Abs()));
...
void CollideSphereVsTriangles::Collide(Vec3Arg inV0, Vec3Arg inV1, Vec3Arg inV2, uint8 inActiveEdges, const SubShapeID &inSubShapeID2)
{
	...
	ACPH_IF_TRACK_NARROWPHASE_STATS(TrackNarrowPhaseCollector track;)
