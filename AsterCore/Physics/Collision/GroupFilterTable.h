...
class ACPH_EXPORT GroupFilterTable final : public GroupFilter
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, GroupFilterTable)
...
private:
	...
	{
		ACPH_ASSERT(inSubGroup1 != inSubGroup2);
		...
		ACPH_ASSERT(inSubGroup2 < mNumSubGroups);
