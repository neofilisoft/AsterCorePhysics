...
#ifndef ACPH_OBJECT_LAYER_BITS
	#define ACPH_OBJECT_LAYER_BITS 16
#endif // ACPH_OBJECT_LAYER_BITS
#if ACPH_OBJECT_LAYER_BITS == 16
	using ObjectLayer = uint16;
#elif ACPH_OBJECT_LAYER_BITS == 32
	using ObjectLayer = uint32;
#else
	#error "ACPH_OBJECT_LAYER_BITS must be 16 or 32"
#endif
...
class ACPH_EXPORT ObjectLayerFilter : public NonCopyable
{
public:
	/// Destructor
...
class ACPH_EXPORT ObjectLayerPairFilter : public NonCopyable
{
public:
	/// Destructor
...
class ACPH_EXPORT DefaultObjectLayerFilter : public ObjectLayerFilter
{
public:
	/// Constructor
...
class ACPH_EXPORT SpecifiedObjectLayerFilter : public ObjectLayerFilter
{
public:
	/// Constructor
