...
#include <AsterCore/Physics/Character/CharacterID.h>
...
#include <AsterCore/Core/STLTempAllocator.h>
...
class ACPH_EXPORT CharacterVirtualSettings : public CharacterBaseSettings
{
public:
...
class ACPH_EXPORT CharacterContactListener
{
public:
	/// Destructor
...
class ACPH_EXPORT CharacterVsCharacterCollision : public NonCopyable
{
public:
...
class ACPH_EXPORT CharacterVsCharacterCollisionSimple : public CharacterVsCharacterCollision
{
public:
...
class ACPH_EXPORT CharacterVirtual : public CharacterBase
{
public:
	ACPH_OVERRIDE_NEW_DELETE
...
private:
	...
	// Helper function to convert a AsterCore collision result into a contact
