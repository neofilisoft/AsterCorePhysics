...
class ACPH_EXPORT CharacterBaseSettings : public RefTarget<CharacterBaseSettings>
{
public:
...
class ACPH_EXPORT CharacterBase : public RefTarget<CharacterBase>, public NonCopyable
{
public:
	ACPH_OVERRIDE_NEW_DELETE
