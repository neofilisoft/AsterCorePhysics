...
ACPH_IMPLEMENT_SERIALIZABLE_NON_VIRTUAL(VehicleDifferentialSettings)
{
	ACPH_ADD_ATTRIBUTE(VehicleDifferentialSettings, mLeftWheel)
	ACPH_ADD_ATTRIBUTE(VehicleDifferentialSettings, mRightWheel)
	ACPH_ADD_ATTRIBUTE(VehicleDifferentialSettings, mDifferentialRatio)
	ACPH_ADD_ATTRIBUTE(VehicleDifferentialSettings, mLeftRightSplit)
	ACPH_ADD_ATTRIBUTE(VehicleDifferentialSettings, mLimitedSlipRatio)
	ACPH_ADD_ATTRIBUTE(VehicleDifferentialSettings, mEngineTorqueRatio)
}
...
void VehicleDifferentialSettings::CalculateTorqueRatio(float inLeftAngularVelocity, float inRightAngularVelocity, float &outLeftTorqueFraction, float &outRightTorqueFraction) const
{
	...
	{
		ACPH_ASSERT(mLimitedSlipRatio > 1.0f);
	...
	ACPH_ASSERT(abs(outLeftTorqueFraction + outRightTorqueFraction - 1.0f) < 1.0e-6f);
}
