...
class ACPH_EXPORT MotorcycleControllerSettings : public WheeledVehicleControllerSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, MotorcycleControllerSettings)
...
class ACPH_EXPORT MotorcycleController : public WheeledVehicleController
{
public:
