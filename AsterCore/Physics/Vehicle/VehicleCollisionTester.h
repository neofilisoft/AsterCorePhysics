...
class ACPH_EXPORT VehicleCollisionTester : public RefTarget<VehicleCollisionTester>, public NonCopyable
{
public:
...
class ACPH_EXPORT VehicleCollisionTesterRay : public VehicleCollisionTester
{
public:
	ACPH_OVERRIDE_NEW_DELETE
...
class ACPH_EXPORT VehicleCollisionTesterCastSphere : public VehicleCollisionTester
{
public:
	ACPH_OVERRIDE_NEW_DELETE
...
class ACPH_EXPORT VehicleCollisionTesterCastCylinder : public VehicleCollisionTester
{
public:
	ACPH_OVERRIDE_NEW_DELETE
	...
	/// @param inConvexRadiusFraction Fraction of half the wheel width (or wheel radius if it is smaller) that is used as the convex radius
									VehicleCollisionTesterCastCylinder(ObjectLayer inObjectLayer, float inConvexRadiusFraction = 0.1f) : VehicleCollisionTester(inObjectLayer), mConvexRadiusFraction(inConvexRadiusFraction) { ACPH_ASSERT(mConvexRadiusFraction >= 0.0f && mConvexRadiusFraction <= 1.0f); }
