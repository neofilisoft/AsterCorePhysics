...
#include <AsterCore/Physics/Vehicle/VehicleDifferential.h>
...
class ACPH_EXPORT WheelSettingsWV : public WheelSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, WheelSettingsWV)
...
class ACPH_EXPORT WheelWV : public Wheel
{
public:
...
class ACPH_EXPORT WheeledVehicleControllerSettings : public VehicleControllerSettings
{
	ACPH_DECLARE_SERIALIZABLE_VIRTUAL(ACPH_EXPORT, WheeledVehicleControllerSettings)
...
class ACPH_EXPORT WheeledVehicleController : public VehicleController
{
public:
	ACPH_OVERRIDE_NEW_DELETE
...
protected:
	...
	// See: VehicleController
	virtual Wheel *				ConstructWheel(const WheelSettings &inWheel) const override { ACPH_ASSERT(IsKindOf(&inWheel, ACPH_RTTI(WheelSettingsWV))); return new WheelWV(static_cast<const WheelSettingsWV &>(inWheel)); }
