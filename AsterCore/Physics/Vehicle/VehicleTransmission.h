...
class ACPH_EXPORT VehicleTransmissionSettings
{
	ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, VehicleTransmissionSettings)
...
class ACPH_EXPORT VehicleTransmission : public VehicleTransmissionSettings
{
public:
