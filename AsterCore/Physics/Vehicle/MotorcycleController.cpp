...
#include <AsterCore/Physics/Vehicle/MotorcycleController.h>
...
ACPH_IMPLEMENT_SERIALIZABLE_VIRTUAL(MotorcycleControllerSettings)
{
	ACPH_ADD_BASE_CLASS(MotorcycleControllerSettings, WheeledVehicleControllerSettings)

	ACPH_ADD_ATTRIBUTE(MotorcycleControllerSettings, mMaxLeanAngle)
	ACPH_ADD_ATTRIBUTE(MotorcycleControllerSettings, mLeanSpringConstant)
	ACPH_ADD_ATTRIBUTE(MotorcycleControllerSettings, mLeanSpringDamping)
	ACPH_ADD_ATTRIBUTE(MotorcycleControllerSettings, mLeanSpringIntegrationCoefficient)
	ACPH_ADD_ATTRIBUTE(MotorcycleControllerSettings, mLeanSpringIntegrationCoefficientDecay)
	ACPH_ADD_ATTRIBUTE(MotorcycleControllerSettings, mLeanSmoothingFactor)
}
...
void MotorcycleController::PreCollide(float inDeltaTime, PhysicsSystem &inPhysicsSystem)
{
	...
	ACPH_DET_LOG("WheeledVehicleController::PreCollide: mTargetLean: " << mTargetLean);
