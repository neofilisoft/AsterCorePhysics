...
#include <Aster/Core/Reference.h>
#include <Aster/Core/Result.h>
#include <Aster/Physics/Body/BodyCreationSettings.h>
#include <Aster/Physics/Constraints/TwoBodyConstraint.h>
#include <Aster/Skeleton/Skeleton.h>
#include <Aster/Skeleton/SkeletonPose.h>
#include <Aster/Physics/EActivation.h>
...
class ACPH_EXPORT RagdollSettings : public RefTarget<RagdollSettings>
{
	ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, RagdollSettings)
...
public:
	...
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, Part)
	...
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, AdditionalConstraint)
...
class ACPH_EXPORT Ragdoll : public RefTarget<Ragdoll>, public NonCopyable
{
public:
