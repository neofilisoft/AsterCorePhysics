...
class ACPH_EXPORT BodyFilter : public NonCopyable
{
public:
	/// Destructor
...
class ACPH_EXPORT IgnoreSingleBodyFilter : public BodyFilter
{
public:
...
class ACPH_EXPORT IgnoreMultipleBodiesFilter : public BodyFilter
{
public:
...
class ACPH_EXPORT IgnoreSingleBodyFilterChained : public BodyFilter
{
public:
	/// Constructor
...
class ACPH_EXPORT BodyDrawFilter : public NonCopyable
{
public:
	/// Destructor
