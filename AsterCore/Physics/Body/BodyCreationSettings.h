...
class ACPH_EXPORT BodyCreationSettings
{
	ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, BodyCreationSettings)
...
public:
	...
	float					mMaxAngularVelocity = 0.25f * ACPH_PI * 60.0f;					///< Maximum angular velocity that this body can reach (rad/s)
