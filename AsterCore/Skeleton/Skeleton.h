...
class ACPH_EXPORT Skeleton : public RefTarget<Skeleton>
{
	ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, Skeleton)
...
public:
	...
	class Joint
	{
		ACPH_DECLARE_SERIALIZABLE_NON_VIRTUAL(ACPH_EXPORT, Joint)
